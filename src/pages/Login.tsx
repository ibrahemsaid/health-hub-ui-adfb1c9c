    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 gradient-bg items-center justify-center p-12">
        <div className="max-w-md text-primary-foreground space-y-6 animate-fade-in">
          ...
          <h1 className="text-4xl font-display font-bold leading-tight">National Health Database System</h1>
          <p className="text-primary-foreground/80 text-lg">
            Secure, reliable, and modern healthcare management for professionals and patients.
          </p>
          <div className="pt-4 space-y-2 text-sm text-primary-foreground/80 bg-white/10 rounded-lg p-4">
